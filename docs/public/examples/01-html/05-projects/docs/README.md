...
[返回首页](../../../README.md) | [返回 HTML 模块](../../README.md) | [学习路线](../../roadmap.html)

通过两个完整项目（个人简历 + 简易博客）将前四个模块的知识融会贯通，建立实际开发思维。

## 学习路线

1. **个人简历**（预计 30 分钟）→ `01-personal-resume.html` + [详细文档](01-personal-resume.md)
   - 综合运用语义标签 + 表格 + 表单 + CSS，制作一份完整简历
2. **简易博客**（预计 40 分钟）→ `02-simple-blog.html` + [详细文档](02-simple-blog.md)
...
| 案例文件 | 配套文档 | 说明 |
|----------|----------|------|
| `01-personal-resume.html` | [01-personal-resume.md](01-personal-resume.md) | 个人简历完整项目 |
| `02-simple-blog.html` | [02-simple-blog.md](02-simple-blog.md) | 简易博客首页完整项目 |
