...
![VitePress](https://img.shields.io/badge/VitePress-1.6-646CFF?style=flat-square&logo=vitepress&logoColor=white)
...
站点通过 GitHub
Pages 自动部署：[https://readant.github.io/frontend-journey/](https://readant.github.io/frontend-journey/)
...
7. JavaScript → 入门运行、变量、函数、对象、数组、异步、DOM、ES 模块、错误调试
