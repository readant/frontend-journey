...
<!-- 在此处插入 ESLint 截图 -->
![ESLint](../../../../assets/images/00-preparation/ESLint.png)
...
<!-- 在此处插入 Stylelint 截图 -->
![Stylelint](./screenshots/stylelint.png)
...
![EditorConfig](./screenshots/editorconfig.png)
...
![React Developer Tools](./screenshots/react-devtools.png)
...
![TypeScript Extension Pack](./screenshots/typescript.png)
...
![Live Server](./screenshots/live-server.png)
...
![Auto Rename Tag](./screenshots/auto-rename-tag.png)
...
![Path Intellisense](./screenshots/path-intellisense.png)
...
![Bracket Pair Colorizer](./screenshots/bracket-pair-colorizer.png)
...
![Code Spell Checker](./screenshots/code-spell-checker.png)
...
![GitHub Pull Requests](./screenshots/github-pr.png)
...
![Material Icon Theme](./screenshots/material-icon-theme.png)
...
![Indent Rainbow](./screenshots/indent-rainbow.png)
...
![TODO Highlight](./screenshots/todo-highlight.png)
...
![REST Client](./screenshots/rest-client.png)
...
![Markdown Preview Enhanced](./screenshots/markdown-preview-enhanced.png)
...
<!-- 在此处插入 SVG Viewer 截图 -->
![SVG Viewer](./screenshots/svg-viewer.png)
...
<!-- 在此处插入 Polacode 截图 -->
![Polacode](./screenshots/polacode.png)
